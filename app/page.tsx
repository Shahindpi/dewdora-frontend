...
export default async function HomePage() {
  ...
  return <SiteShell>
    ...
    {visible.newsletter && <section className="mt-16 rounded-3xl bg-[#165e46] p-8 text-white sm:p-10"><h2 className="text-2xl font-bold">Fresh finds in your inbox</h2><p className="mt-3 text-[#d7ecdf]">Get new articles and tools as they arrive.</p><NewsletterForm /></section>}
  </SiteShell>;
}
